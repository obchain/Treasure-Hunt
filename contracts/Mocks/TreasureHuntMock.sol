...
contract TreasureHuntMock is VRFConsumerBaseV2Plus {
    /**
   ...
   /**
    ...
    constructor(
        ...
        uint8 _initial_treasure_position
        ...
        uint8 initialTreasurePosition = _initial_treasure_position;
   ...
   /**
    ...
    function feedRandomWords(uint256 _requestId, uint256[] calldata _randomWords) external {
    ...
    function setRequestInExecution(uint256 _requestID, uint8 _position) external {
        request.requestId  = _requestID;
        request.newPosition = _position;
    }
